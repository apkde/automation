...
function initVoiceCommands() {
    ...
    function handleVoiceCommand(command) {
        ...
        voiceWave.classList.remove('animate-pulse');
        document.getElementById('voice-visualizer').style.opacity = '0.3';
        ...
        .then(data => {
            ...
            typeWriter(voiceStatus, data.response, 50);
            ...
            switch(data.action) {
                case 'generate':
                    if (data.input_text) {
                        ...
                        document.getElementById('input-text').scrollIntoView({ behavior: 'smooth' });
                ...
                case 'export':
                    // Visual feedback
                    document.getElementById('export-btn').classList.add('highlight');
                    document.getElementById('export-btn').click();
                    break;
                    
                case 'clear':
                    // Fade out effect
                    fadeOut(document.getElementById('input-text'));
                    fadeOut(document.getElementById('result'));
                    setTimeout(() => {
                        document.getElementById('input-text').value = '';
                        document.getElementById('result').textContent = '';
                        fadeIn(document.getElementById('input-text'));
